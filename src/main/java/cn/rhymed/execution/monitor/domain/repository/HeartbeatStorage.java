...
public interface HeartbeatStorage {
     ...
     * 根据任务ID查找心跳记录
     */
    Optional<HeartbeatRecord> findByExecutionId(ExecutionId executionId);
     ...
     * 删除心跳记录
     */
    void deleteByExecutionId(ExecutionId executionId);
     ...
     * 批量删除
     */
    void deleteBatch(List<ExecutionId> executionIds);
}
