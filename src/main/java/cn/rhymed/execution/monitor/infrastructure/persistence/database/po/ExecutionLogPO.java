...
public class ExecutionLogPO {
     ...
     * 从领域对象转换为PO
     */
    public static ExecutionLogPO fromDomain(ExecutionRecord execution) {
        ExecutionLogPO po = new ExecutionLogPO();
        po.setExecutionId(execution.getExecutionId().getValue());
