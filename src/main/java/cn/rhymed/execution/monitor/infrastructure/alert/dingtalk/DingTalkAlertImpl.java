...
public class DingTalkAlertImpl implements AlertService {
    ...
    private String buildFailureContent(ExecutionRecord execution) {
        ...
        content.append("**任务名称**: ").append(execution.getExecutionName()).append("\n");
        content.append("**任务ID**: ").append(execution.getExecutionId()).append("\n");
    ...
    private String buildRetryContent(ExecutionRecord execution, int retryCount) {
        String content = "**任务名称**: " + execution.getExecutionName() + "\n" +
                "**任务ID**: " + execution.getExecutionId() + "\n" +
                "**当前重试**: 第" + retryCount + "次\n" +
